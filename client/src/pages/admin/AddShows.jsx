            ...
            <div className="overflow-x-auto pb-4">
                <div className="flex flex-wrap gap-4 mt-4 w-max">
                    {nowPlayingMovies.map((movie) => (
                        <div
                            key={movie.id}
                            className={`relative w-40 cursor-pointer transition-transform duration-300 hover:-translate-y-1 group`}
                        ...
                        >
                            ...
                            <div className="relative rounded-lg overflow-hidden mb-2">
                                ...
                                />
                                <div className="absolute bottom-0 left-0 w-full p-2 bg-black/70 flex justify-between items-center text-sm">
                            ...
                            <p className="font-medium text-sm leading-snug truncate">{movie.title}</p>
